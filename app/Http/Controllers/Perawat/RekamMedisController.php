...
class RekamMedisController extends Controller
{
    public function index()
    {
        ...
        return view('perawat.rekammedis.index', compact('records'));
    }
    ...
    public function show($id)
    {
        ...
        return view('perawat.rekammedis.show', compact('record', 'details'));
    }
    ...
    public function edit($id)
    {
        ...
        $reservations = DB::table('temu_dokter as td')
            ...
            ->where(function($query) use ($record) {
                // Show reservations without medical records OR the current reservation being edited
                $query->whereNull('rm.idrekam_medis')
    ...
    public function addDetail($id)
    {
        ...
        return view('perawat.rekammedis.adddetail', compact('record', 'categories', 'treatmentCodes'));
    }
