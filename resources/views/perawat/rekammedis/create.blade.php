                                ...
                                <select class="form-select @error('idreservasi_dokter') is-invalid @enderror" 
                                    ...
                                    @foreach($reservations as $reservation)
                                        <option value="{{ $reservation->idreservasi_dokter }}" 
                                                {{ old('idreservasi_dokter') == $reservation->idreservasi_dokter ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('anamnesa') is-invalid @enderror" 
                                          ...
                                          rows="3" 
                                          required
                                          placeholder="Riwayat penyakit dan gejala yang dialami hewan...">{{ old('anamnesa') }}</textarea>
                                @error('anamnesa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('temuan_klinis') is-invalid @enderror" 
                                          ...
                                          rows="3" 
                                          required
                                          placeholder="Hasil pemeriksaan fisik dan temuan klinis lainnya...">{{ old('temuan_klinis') }}</textarea>
                                @error('temuan_klinis')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('diagnosa') is-invalid @enderror" 
                                          ...
                                          rows="2" 
                                          required
                                          placeholder="Diagnosa berdasarkan anamnesa dan temuan klinis...">{{ old('diagnosa') }}</textarea>
                                @error('diagnosa')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
