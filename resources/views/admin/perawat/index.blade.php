            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('admin.perawat.destroy', $perawat->id_perawat) }}" method="POST" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus perawat ini?');">
                            @csrf
                            @method('DELETE')
